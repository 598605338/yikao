		...
		<section class="common_cont height_auto">
			...
			<aside id="left_goods" class="cont_aside height_auto left left_channel">
			  <ul class="one">
			    <li class="cont_aside_header">
			    	<div class="cont_aside_item cont_aside_header">
			      		<a class="a ab" href="<%=basePath%>/product/select" target="target" ><i style="width:18px;height:18px;background-size:204%;background-position:0 -18px;" class="small icon icon-goods icon-2"></i>商品管理<p class="ac"><img src="dist/images/1.png"/></p></a>
			    	</div>    
				</li>  
				<li>
					<div class="cont_aside_item">
						<a class="a ab" href="<%=basePath%>/productCatagory/selectLargeCatagory" target="target" ><i style="width:18px;height:18px;background-size:204%;background-position:0 -37px;" class="small icon icon-goods icon-3"></i>商品分类<p class="ac"><img src="dist/images/1.png"/></p></a>
				    </div>
				</li>
				<li>
					<div class="cont_aside_item">
						
						<a class="a ab" href="<%=basePath%>/brand/select" target="target" ><i class="icon icon-goods icon-1"></i>商品品牌<p class="ac"><img src="dist/images/1.png"/></p></a>
						 
					</div>
				</li>
				<li>
					<div class="cont_aside_item">
						<a class="a ab"  href="<%=basePath%>/unit/select" target="target" ><i class="icon icon-goods icon-4"></i>商品单位<p class="ac"><img src="dist/images/1.png"/></p></a>
					</div>
				</li>
				<li>
					<div class="cont_aside_item">
						<a class="a ab"  href="<%=basePath%>/tags/select" target="target" ><i class="icon icon-goods icon-5"></i>商品标签<p class="ac"><img src="dist/images/1.png"/></p></a>
					</div>
				</li>
			  </ul>
			</aside>
			<aside id="left_activities" class="cont_aside height_auto left">
				<ul class="one">
					...
					<li class="cont_aside_header">
						<div class="cont_aside_item">
						     <a class="a ab" href="<%=basePath%>/activityMiaosha/select" target="target" ><i class="icon icon-activities icon-4"></i>秒杀管理<p class="ac"><img src="dist/images/1.png"/></p></a>
						</div>
					<li>
					<li>
					    <div class="cont_aside_item">
					          <a class="a ab" href="<%=basePath%>/pintuan/getPtBaseList" target="target" ><i class="icon icon-activities icon-5"></i>团购管理<p class="ac"><img src="dist/images/1.png"/></p></a>
					    </div>
					</li>			
					<li>
					    <div class="cont_aside_item">
					           <a class="a ab" href="<%=basePath%>/tailGoodsClear/select" target="target" ><i class="icon icon-activities icon-6"></i>尾货清仓<p class="ac"><img src="dist/images/1.png"/></p></a>
					    </div>
					</li>
					<li>
					    <div class="cont_aside_item">
					         <a class="a ab" href="<%=basePath%>/activityPrepare/select" target="target"><i class="icon icon-activities icon-8"></i>预约购买<p class="ac"><img src="dist/images/1.png"/></p></a>
					    </div>
					</li>	
					<li>
					    <div class="cont_aside_item">
					        <a class="a ab" href="<%=basePath%>/scoreProduct/select" target="target"><i class="icon icon-activities icon-2"></i>积分商城<p class="ac"><img src="dist/images/1.png"/></p></a>
					    </div>
					</li>	
					<li>
					    <div class="cont_aside_item">
					        <a class="a ab" href="javascript:" target="target"><i class="icon icon-activities icon-1"></i>促销管理<p class="ac myDir"><img src="dist/images/1.png"/></p></a>
					         <ul class="two" style="display:none">
						         ...
						         <li class="list listt ding"><span class="span1">.</span><a href="<%=basePath%>/promotion/selectActInfoAll?activity_type=4" target="target" class="a discoun">加钱换购</a></li>
						         <li class="list listt"><span class="span1">.</span><a href="<%=basePath%>/promotion/selectActInfoAll?activity_type=3" target="target" class="a halff">第二件半价</a></li>
						     </ul> 
					    </div>
					</li>
					 <li class="cont_aside_header">
						<div class="cont_aside_item cont_aside_header">
						    <a class="a ab" href="<%=basePath%>/receiveCardCoupon/select" target="target" ><i class="icon icon-activities icon-3"></i>领券中心<p class="ac"><img src="dist/images/1.png"/></p></a>
						</div>
					</li>
					 <li class="cont_aside_header">
						<div class="cont_aside_item cont_aside_header">
						    <a class="a ab" href="<%=basePath%>/newProductRecommend/select" target="target" ><i class="icon icon-activities icon-7"></i>新品推荐<p class="ac"><img src="dist/images/1.png"/></p></a>
						</div>
					</li>
					 <li class="cont_aside_header">
						<div class="cont_aside_item cont_aside_header">
						    <a class="a ab" href="<%=basePath%>/hotsell/select" target="target" ><i class="icon icon-activities icon-7"></i>热销推荐<p class="ac"><img src="dist/images/1.png"/></p></a>
						</div>
					</li>
			  </ul>	
			</aside>
			<aside id="left_mallshops" class="cont_aside height_auto left">
				 <ul class="one">
					<li>
					    <div class="cont_aside_item cont_aside_header">
					         <a class="a ab" href="<%=basePath%>/shop/shopList" target="target"><i class="icon icon-mallshops icon-2"></i>基本管理<p class="ac"><img src="dist/images/1.png"/></p></a> 
					    </div>
					</li>
					<li>
					    <div class="cont_aside_item">
					         <a class="a ab" href="<%=basePath%>/shop/queryShopProducts" target="target"><i class="icon icon-mallshops icon-1"></i>门店商品<p class="ac"><img src="dist/images/1.png"/></p></a>
					    </div>
					</li>
			     </ul>
			</aside>
			<aside id="left_coupons" class="cont_aside height_auto left">
			     <ul class="one">
				    <li>
				       <div class="cont_aside_item cont_aside_header">
				            <a class="a ab" href="<%=basePath%>/cardCoupon/select" target="target" ><i class="icon icon-coupons icon-1"></i>卡券管理<p class="ac"><img src="dist/images/1.png"/></p></a>
				       </div>
				    </li>   
				    <li>
				        <div class="cont_aside_item">
				            <a class="a ab" href="<%=basePath%>/cardCoupon/selectThird" target="target" ><i class="icon icon-coupons icon-2"></i>三方卡券<p class="ac"><img src="dist/images/1.png"/></p></a>
				        </div>
				    </li>               
				</ul>
			</aside>
			...
			<ul class="one">
				<li>
				   <div class="cont_aside_item">
				         <a class="a ab" href="<%=basePath%>/orderQuery/getOrderList" target="target"><i class="icon icon-orders icon-1"></i>订单列表<p class="ac"><img src="dist/images/1.png"/></p></a>
				   </div>
				</li>
				<!--<li>
				   <div class="cont_aside_item">
				...
				<li>
				   <div class="cont_aside_item">
				         <a class="a ab" href="<%=basePath%>/orderQuery/scorelist" target="target"><i class="icon icon-orders icon-2"></i>积分订单<p class="ac"><img src="dist/images/1.png"/></p></a>
				   </div>
				</li>
				<li>
				   <div class="cont_aside_item">
				         <a class="a ab" href="<%=basePath%>/orderQuery/pinTuanlist" target="target"><i class="icon icon-orders icon-3"></i>团购订单<p class="ac"><img src="dist/images/1.png"/></p></a>
				   </div>
				</li>
				<li>
				   <div class="cont_aside_item">
				         <a class="a ab" href="<%=basePath%>/orderQuery/refundOrderlist" target="target"><i class="icon icon-orders icon-4"></i>退款订单<p class="ac myDir"><img src="dist/images/1.png"/></p></a>
				         <ul class="two" style="display:none">
				            <li class="list listt"><span class="span1">.</span><a href="<%=basePath%>/jsp/views/order/refund_order_add.jsp" target="target" class="a detaa">添加退款单</a></li>
				         </ul>
				   </div>
				</li>
		    </ul>		
			...
			<aside id="left_operate" class="cont_aside height_auto left">
			   ...
			   <li>
					    <div class="cont_aside_item">
					         <a class="a ab" href="<%=basePath%>/secuser/select" target="target" ><i class="icon icon-operate icon-4"></i>系统用户<p class="ac myDir"><img src="dist/images/1.png"/></p></a>
					    </div>
					</li>
			</ul>
			</aside>
			...
			<ul class="one">
				<li>
				    <div class="cont_aside_item cont_aside_header">
				         <a class="a ab" href="<%=basePath%>/jsp/views/report/sumAllSales.jsp" target="target" ><i class="icon icon-finance icon-10"></i>总销报表<p class="ac"><img src="dist/images/1.png"/></p></a>
				    </div>
				</li>
				<li>
				   <div class="cont_aside_item">
				        <a class="a ab" href="<%=basePath%>/jsp/views/report/sumSalesByPriceInterval.jsp" target="target"><i class="icon icon-finance icon-3"></i>客单分布<p class="ac"><img src="dist/images/1.png"/></p></a>
				        
				   </div>
				</li>
				<li>
				    <div class="cont_aside_item">
				        <a class="a ab" href="<%=basePath%>/jsp/views/report/sumMallsSales.jsp" target="target"><i class="icon icon-finance icon-1"></i>店铺销售<p class="ac"><img src="dist/images/1.png"/></p></a>
				    </div>
				</li>
				<li>
				    <div class="cont_aside_item">
				         <a class="a ab" href="<%=basePath%>/jsp/views/report/sumSalesByTimeInterval.jsp" target="target"><i class="icon icon-finance icon-9"></i>销售时段<p class="ac"><img src="dist/images/1.png"/></p></a>
				    </div>
				</li>
			
				<li>
				    <div class="cont_aside_item">
				         <a class="a ab" href="<%=basePath%>/jsp/views/report/sumHotProductsSales.jsp" target="target"><i class="icon icon-finance icon-6"></i>热销商品<p class="ac"><img src="dist/images/1.png"/></p></a>
				    </div>
				</li>
				<li>
				    <div class="cont_aside_item">
				         <a class="a ab" href="<%=basePath%>/jsp/views/report/sumSalesCategories.jsp" target="target"><i class="icon icon-finance icon-7"></i>商品类别<p class="ac"><img src="dist/images/1.png"/></p></a> 
				    </div>
				</li>
				<li>
				    <div class="cont_aside_item">
				         <a class="a ab" href="<%=basePath%>/jsp/views/report/sumSendExposure.jsp" target="target"><i class="icon icon-finance icon-8"></i>商城配送<p class="ac"><img src="dist/images/1.png"/></p></a> 
				    </div>
				</li>
				<li>
				    <div class="cont_aside_item">
				         <a class="a ab" href="<%=basePath%>/jsp/views/report/sumInventorySales.jsp" target="target"><i class="icon icon-finance icon-5"></i>清仓销售<p class="ac"><img src="dist/images/1.png"/></p></a> 
				    </div>
				</li>
				<li>
				    <div class="cont_aside_item">
				         <a class="a ab" href="<%=basePath%>/jsp/views/report/sumLackProducts.jsp" target="target"><i class="icon icon-finance icon-4"></i>门店缺货<p class="ac"><img src="dist/images/1.png"/></p></a>
				    </div>
				</li>
	            <li>
				    <div class="cont_aside_item">
				          <a class="a ab" href="<%=basePath%>/jsp/views/report/sumMallsSalesByDate.jsp" target="target"><i class="icon icon-finance icon-4"></i>店铺销售<p class="ac"><img src="dist/images/1.png"/></p></a>
				    </div>
				</li>
			</ul>	
			</aside>
			...
			<ul class="one">
				<li>
				   <div class="cont_aside_item cont_aside_header">
				        <a class="a ab" href="<%=basePath%>/cust/queryCust" target="target"><i class="icon icon-leaguer icon-3"></i>会员管理<p class="ac"><img src="dist/images/1.png"/></p></a> 
				   </div>
				</li>
				<li>
				    <div class="cont_aside_item">
				          <a class="a ab" href="<%=basePath%>/cust/getAccountcashdepositRecordList" target="target"><i class="icon icon-leaguer icon-1"></i>充值记录<p class="ac"><img src="dist/images/1.png"/></p></a> 
				    </div>
				</li>
				<li>
				   <div class="cont_aside_item">
				         <a class="a ab" href="<%=basePath%>/cust/accountcashdepositConfig?id=1" target="target"><i class="icon icon-leaguer icon-2"></i>充值设置<p class="ac"><img src="dist/images/1.png"/></p></a>
				   </div>
				</li>
			</ul>	
			</aside>
			...
			<ul class="one">
				...
				<li>
				    <div class="cont_aside_item">
				          <a class="a ab" href="<%=basePath%>/admissionBatch/select" target="target"><i class="icon icon-leaguer icon-1"></i>批次管理<p class="ac"><img src="dist/images/1.png"/></p></a>
				    </div>
				</li>
				<%--<li>
				    <div class="cont_aside_item">
				...
				<li>
				   <div class="cont_aside_item">
				         <a class="a ab" href="<%=basePath%>/admissionInfo/select?pageSize=100" target="target"><i class="icon icon-leaguer icon-2"></i>成绩管理<p class="ac"><img src="dist/images/1.png"/></p></a>
				   </div>
				</li>
			</ul>
			</aside>
			...
			<footer class="common_bot">
				<p class="height ft_sm" style="margin-top:0;">京ICP备16008969号-1&nbsp;www.linjia-cvs.cn 保留所有权利。</p>
			</footer>
		</section>
