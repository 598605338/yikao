...
<c:out value="${message }" />
				...
				<section class="cont_section_section_border">					
					<div class="goodsManage">
						<form name="formain" id="formain" method="post" action="<%=path%>/promotion/insertFullMinus" >
							...
							<div class="editPage">
								<div class="editLeft">
									...
									<div class="row-list">
										<label>促销日期：</label>
										<input style="width:30%;" placeholder="促销时间起" class="datatime-input" type="text"  name="beginDate" id="beginDate" value="${query.beginDate}" >
										<p style=" float:left;width:3%;display:inline-block;text-align: center; margin-left: -1px; margin-right: 1px;line-height: 32px;">~</p>
										<input style="width:30%;" placeholder="促销时间止" class="datatime-input" type="text"  name="endDate" id="endDate" value="${query.endDate}" >
									...
									<div class="row-list">
										<label>促销条件：</label>
										<input style="float:left;border:none;" type="radio" id="ifaddPromotion" name="ifaddPromotion" value=1 class="leftt" checked="checked" />
										<span style="float:left;margin-top:2px;">满</span>
										<input style="width:54%;margin-left:7px;" name="promotion_condition_1" id="promotion_condition_1" type="text" class="leftt" value="${query.promotion_condition_1}"/><b>元</b>
									</div>
									<div class="row-list">
										<label></label>
										<input type="radio" id="ifaddPromotion" name="ifaddPromotion" value=0 class="left"> 
										<span style="float:left;margin-top:2px;" >满</span>
										<input style="width:54%;margin-left:7px;" name="promotion_condition_2" id="promotion_condition_2" type="text" style="float:left;" value="${query.promotion_condition_2}"/><b>件</b>
									</div>
									<div class="row-list">
										<label>满减金额：</label>
										<input class="td_text_w" name="fullReduceMoney" id="fullReduceMoney" type="text" class="left" value="${query.fullReduceMoney}"/><b>元</b>
									</div>
								</div>
								<div class="line"></div>
								<div class="editRigth">
									<div class="row-list">
										...
										<input style="margin-left:20px;" class="left"  type="radio" id="if_useCardCoupons" value=0  name="if_useCardCoupons" checked="checked" checked="checked" /><span style="margin-top: 2px;" class="left">否</span>
									</div>
									<div class="row-list">
										<label>是否首单生效：</label>
										<input class="left" type="radio" id="if_first_work" value=1 name="if_first_work" checked="checked" /><span style="margin-top: 2px;" class="left" >是</span>
									...
									<div class="row-list">
										<label>参与门店：</label>
										<input class="left" type="radio" id="ifAllMalls" value=1 name="ifAllMalls" checked="checked" onchange="btnOnchange()" /><span style="margin-top: 2px;" class="left" >全部门店</span>
									...
									<div class="row-list" id="addMallBtn" style="display: none;">
										<label><a href="<%=basePath%>/shop/shopwinList?pageIndex=1" target="popupWin1" onclick="popupProOpen1();"><span class="back_dblue left btn" style="margin: 0;"><i class="icon-btn icon-add"></i>添加门店</span></a></label>
						...
						<hr>
							<div class="section_table" style="border: 0;">
						<table cellspacing="none">
								...
								<a href="" id="popupLink" target="popupWin" onclick="setProductIds();popupProOpen();"><span style="display:inline-block;" class="back_dblue btn cbn compa""><i class="icon-btn icon-add"></i>添加商品</span></a>
				...
				<div class="bgbtn">
	                ...
	                <span  class="right back_dblue btn cnt" onclick="window.history.back()">返回</span> -->
	...
	var trim_Version=version[1].replace(/[ ]/g,""); 
	 ...
	 var iframe = $("#popupDiv").get(0);
	 if (iframe.attachEvent){
		iframe.attachEvent("onload", function(){
			console.log("*********************************")
			console.log(window.parent.$(".wrap").height)
			/*if($("wrap"))
			{
