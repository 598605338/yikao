...
//				var _obj=$(this).parent().nextSibling().find("#pro_item").find(".goods_tr"),_str="";
//				_obj.each(function(i){
//					_str+=_obj.eq(i).find("td").eq(1).val()+"";
//				});
//			}
			//弹出门店窗口
...
<div id="wrap">
<c:out value="${message }" />
				<!-- <header class="cont_section_header">商品折扣</header> -->
				<header class="cont_section_header_bread">
					<i class="icon-op icon-op-address" style="margin-right:5px;"></i>当前位置：
					<a href="javascript:void(0);" class="topNavClick" style="color: #323232;">活动</a><span>&gt;</span>
					<a href="javascript:void(0);" class="leftNavClickList" style="color: #323232;">商品折扣</a><span>&gt;</span>
					<span style="color:#3bb3e0;">新增促销</span>
				</header>
					...
					<div class="goodsManage">
						...
						<div class="editPage">
							<div class="editLeft">
								...
								<div class="row-list">
									<label>促销折扣：</label>
									<input class="td_text_w" name="discount" id="discount" type="text"  value="${query.discount}"/>
								</div>
								<div class="row-list">
									<label>参与门店：</label>
									<input class="left" type="radio" id="ifAllMalls" value=1 name="ifAllMalls" onchange="btnOnchange()" checked="checked" /><span  class="left" style="margin-top: 2px;" checked="checked" />全部门店</span>
						...
						<hr>
							...
							<table cellspacing="none">
							  ...
							  <span >
							  	...
							  	<a href="" id="popupLink" target="popupWin" onclick="setProductIds();popupProOpen();"><span style="display:inline-block;margin:5px 0px 0px 0px;" class="back_dblue btn add_btn compa" ><i class="icon-btn icon-add"></i>添加商品</span></a>
							  </span>
				...
				<div class="bgbtn">
					...
					<span style="width:30px;height:30px;" class="right back_dblue btn left" onclick="window.history.back()">返回</sapn> -->
    ...
    <div id="popupDiv" style="position: absolute;z-index:1002;display:none;width: 90%; height: 90%; background-color: white; position: absolute; left: 5%; top:6%;padding: 0 14px;">
        <span class="disp" onclick="popupProClose();" style="cursor:pointer;position:absolute;top:-20px;right:-20px;height:30px;width:30px;border-radius:20px;line-height:33px;font-size:18px;color:#fff;text-align:center;background:#939393;">×</span>  
    ...
    <div id="popupDiv1" style="position: absolute;z-index:1002;display:none;width: 90%; height: 90%; background-color: white; position: absolute; left: 5%; top:6%;padding: 0 14px;">
...
<script type="text/javascript">
	...
	var trim_Version=version[1].replace(/[ ]/g,""); 
	 if(browser=="Microsoft Internet Explorer" && trim_Version=="MSIE9.0") {
	  $(".compa").css("margin","5px 7px 9px 3px")
	}
