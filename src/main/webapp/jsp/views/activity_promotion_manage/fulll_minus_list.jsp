			...
			function delAll(type){
					var activity_ids="";
						...
						if(activity_ids){
							...
							window.location.href="<%=path%>/promotion/deleteActInfoById?activity_ids="+data1+"&activity_type=1";
						}
			}
					...
					<div class="goodsManage">
						...
						<form name="formain" id="formain" method="post" action="<%=path%>/promotion/selectActInfoAll">
							<div class="row">
								...
								<input class="datatime-input" placeholder="促销时间止" type="text" name="endDate" id="endDate" value="${query.endDate}" />
							...
							<div class="col-click">
								<span ><button type="button" onclick="document.getElementById('formSearch').submit();" class="left back_dblue col_white btn"><i class="icon-btn icon-search"></i>查询</button></span>
						...
						<div class="height compa" style="margin:7px 0px -13px -5px">
						...
						<thead style="background:#EBEBEB;">
							<th><input style="margin-left:28%;" type="checkbox" name="all" id="all" onclick="doChoose()"/></th>
							<th>创建时间</th>
							<th>促销名称</th>
							<th>活动类型</th>
							<th>开始日期</th>
						...
						 	<tr class="goods_tr">
								<td><input style="margin-left:28%;" type="checkbox" name="activity_id" id="activity_id" value="${activity.activity_id}" onclick="chooseSingle()"></td>
...
var trim_Version=version[1].replace(/[ ]/g,""); 
 if(browser=="Microsoft Internet Explorer" && trim_Version=="MSIE9.0") {
  $(".compa").css("margin","5px 0px -19px 0px")
}
</script>
