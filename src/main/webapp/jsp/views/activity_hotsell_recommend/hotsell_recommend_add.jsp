...
<c:out value="${message }" />
				...
				<section class="cont_section_section_border">					
					<div class="goodsManage">
						<form name="formain" id="formain" method="post" action="add" enctype="multipart/form-data">
						
						<div class="editPage">
							<div class="editLeft">
								<div class="row-list">
									<label>活动名称<span style="color:red">*</span>：</label>
									<input class="td_text_w" name="name" id="name" type="text" class="left" value="${query.activity_name}"/>
								</div>
								<div class="row-list">
								...
								<div class="row-list">
									...
									<input style="width:30%;" type="text" placeholder="活动时间起" name="startTimeStr" id="startTimeStr" value="" class="datatime-input"/>
									<p style=" float:left;width:3%;display:inline-block;text-align: center; margin-left: -1px; margin-right: 1px;line-height: 32px;">~</p>
									<input style="width:30%;" type="text" placeholder="活动时间止" name="endTimeStr" id="endTimeStr" value="" class="datatime-input"/>
								</div>
							</div>
							<div class="line"></div>
							<div class="editRight">
