						...
						<form name="formain" id="formain" method="post" action="<%=path%>/promotion/updateActivityInfo" >
							...
							<div class="editPage">
								<div class="editLeft">
									...
									<div class="row-list">
										<label>是否可累计：</label>
										<input class="left" type="radio" id="if_add" value=1 name="if_add"><span class="left" style="margin-top: 2px;">是</span>
										<input class="left" type="radio" id="if_add" value=0 name="if_add"><span class="left" style="margin-top: 2px;">否</span>
									</div>
									<div class="row-list">
										<label>参与门店：</label>
										<input class="left" type="radio" id="ifAllMalls" value=1 name="ifAllMalls" onchange="btnOnchange()"><span class="left" style="margin-top: 2px;">全部门店</span>
										<input style="margin-left:20px;" class="left" type="radio" id="ifAllMalls" value=0 name="ifAllMalls" onchange="btnOnchange()"><span class="left" style="margin-top: 2px;">部分门店</span>
										<input type="hidden" id="mall_codes" value="${activityInfo.mall_codes}" name="mall_codes">
									</div>
									<div id="addMallBtn" class="row-list">
										<label><a href="<%=basePath%>/shop/shopwinList?pageIndex=1" target="popupWin1" onclick="popupProOpen1();"><span style="display:inline-block;margin-left:0%;width:52px;height:30px;" class="back_dblue left btn">添加门店</span></a></label>
