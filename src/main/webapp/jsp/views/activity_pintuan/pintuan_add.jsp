...
window.onload=function(){		 
	 ...
	 function doWithAmount(){
	    ...
	    function doSubmitCheck(){
			...
			var imageSrc = form.imageSrc.src;
...
<div id="wrap">
<c:out value="${message }" />
				<!-- <header class="cont_section_header">添加拼团</header> -->
				<header class="cont_section_header_bread">
					...
					<span style="color:#3bb3e0;">新增团购</span>
				</header>
				<section class="cont_section_section_border">					
					<div class="goodsManage">
						<div>
						<form name="formain" id="formain" method="post" action="<%=path%>/pintuan/addBaseInfo" enctype="multipart/form-data">
							<div class="editPage">
								<div class="editLeft">
									<div class="row-list">
										<label class="left">发布时间：</label>
										<input class="datatime-input td_text_w" style="width: 30%;" placeholder="发布时间起" type="text"  name="startTimeStr" id="startTimeStr" value="${baseInfo.startTimeStr}" >
										<p style=" float:left;width:3%;display:inline-block;text-align: center; margin-left: -1px; margin-right: 1px;line-height: 32px;">~</p>
										<input class="datatime-input td_text_w" style="width: 30%;" placeholder="发布时间止" type="text" name="endTimeStr" id="endTimeStr" value="${baseInfo.endTimeStr}" >
									</div>
									<div class="row-list">
										<label class="left">活动人数：</label>
										<input style="float:left;width:30%;"  name="lowerLimit" id="lowerLimit" type="text" class="left" value="2" readonly="readonly" />
										<p style=" float:left;width:3%;display:inline-block;text-align: center; margin-left: -1px; margin-right: 1px;line-height: 32px;">~</p>
										<input style="width: 30%;"  name="upperLimit" id="upperLimit" type="text" class="left" value="5" readonly="readonly" />
									</div>
									<div class="row-list">
										<label class="left">活动时间：</label>
										<input  name="work_time" id="work_time" readonly="readonly" type="text" value=10 class="left td_text_w"  />
									</div>
									<div class="row-list">
										<label class="left">商品名称：</label>
										<input class="left td_text_w" style="width: 47.5%;margin-right: 1.7%;" name="pName" id="pName" value="${baseInfo.pName}" type="text" />
									...
									<div class="row-list">
										...
										<input class="td_text_w" name="pCode" id="pCode" value="${baseInfo.pCode}" type="text"  readonly="readonly" />
									</div>
									<div class="row-list">
										<label class="left">商品市场价格：</label>
										<input class="td_text_w" name="marketPrice" id="marketPrice" type="text" value="${baseInfo.marketPrice}" readonly="readonly" />
									</div>
									<div class="row-list">
										<label class="left">描述：</label>
										<textarea class="td_text_w" id="content" cols="60" rows="6" onkeydown="gbcount();" onkeyup="gbcount();"></textarea>
										<input name="description" id="description" type="hidden" value="${baseInfo.description}"/>
								...
								<div class="editRight">
									<div class="row-list">
										...
										<input class="td_text_w" name="ptPrice" id="ptPrice" type="text" value="${baseInfo.ptPrice}"/>
									</div>
									<div class="row-list">
										<label class="left">参与活动库存：</label>
										<input class="td_text_w"  name="quantity" id="quantity" type="text" value="${baseInfo.quantity}"/>
									</div>
									<div class="row-list">
										<label class="left">赠送积分：</label>
										<input class="td_text_w"  name="giveScore" id="giveScore" type="text"  value="${baseInfo.giveScore}"/>
									</div>
									<div class="row-list">
										...
										<div class="imgbox">
		    								<div class="imgnum">
		        								...
		        								<input type="hidden" value="" id="imagePath2" name="imagePath2">
		    								</div>
										</div>
									...
									<div class="row-list">
										...
										<input class="td_text_w"  name="sortIndex" id="sortIndex" type="text"value="${baseInfo.sortIndex}"/>
										<input style="width:44%;float:left;"  name="productId" id="productId" type="hidden" value="${baseInfo.productId}"/>
									</div>
								</div>
							</div>						
						</form>
				...
				<div class="bgbtn">
					<!-- <input style="float:left;" type="submit" class="left back_dblue col_white btn" value="保存" />
					<input style="float:left;"   type="button" class="left back_dblue col_white btn" value="重置" onClick="cleanForm();" />
					<p style="display:inline-block;float:left;"  class="right back_dblue btn" onclick="window.history.back()">返回</p> -->
					<button type="button" style="float:left;" onclick="doSubmitCheck()" class="left back_dblue btn" ><i class="icon-btn icon-save"></i>保存</button>
					<button type="button" style="float:left;" class="left back_dblue btn" onClick="cleanForm();" ><i class="icon-btn icon-reset"></i>重置</button>
					<p style="display:inline-block;float:left;"  class="right back_dblue btn" onclick="window.history.back()"><i class="icon-btn icon-goback"></i>返回</p>
				</div>
				<!-- 弹出框 -->
