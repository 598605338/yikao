...
<c:out value="${message }" />
				...
				<section class="cont_section_section_border">					
					<div class="goodsManage">
						...
						<div class="editPage">
							<div class="editLeft">
								<div class="row-list">
									<label>促销名称：</label>
									<input class="td_text_w" name="activity_name" id="activity_name" type="text" value="${query.activity_name}"/>
								</div>
								<div class="row-list">
									<label>促销日期：</label>
									<input style="width:30%;" class="datatime-input" placeholder="促销日期起" type="text"  name="beginDate" id="beginDate" value="${query.beginDate}" >
									<p style=" float:left;width:3%;display:inline-block;text-align: center; margin-left: -1px; margin-right: 1px;line-height: 32px;">~</p>
									<input style="width:30%;" class="datatime-input" placeholder="促销日期止" type="text"  name="endDate" id="endDate" value="${query.endDate}" >
								</div>
								<div class="row-list">
									<label>优先级：</label>
									<input class="td_text_w" class="wide" name="priority" id="priority" type="text" class="left" value="${query.priority}"/>
								</div>
								<div class="row-list">
									<label>是否使用卡劵：</label>
									...
									<input class="left" type="radio" id="if_useCardCoupons" value=0  name="if_useCardCoupons" checked="checked" /><span style="margin-top: 2px;" class="left">否</span>
								</div>
								<div class="row-list">
									<label>参与门店：</label>
								...
								<div class="row-list">
									<label>促销标签：</label>
									<input class="td_text_w" type="text" id="promotion_label" name="promotion_label">
					...
					<!--	<header class="cont_section_tab_header">商品筛选器</header>	-->
							...
							<table cellspacing="none">
								...
								<a href="" target="popupWin" id="popupLink" onclick="setProductIds();popupProOpen();"><span style="display:inline-block;margin:6px 0 0 0;" class="back_dblue btn compa"><i class="icon-btn icon-add"></i>添加商品</span></a>
								</span>
						...
						<hr style="margin-top: 17px;">
						   ...
						   <span>
						   <input type="hidden" class="td_text_w" name="tradeProductIds" id="tradeProductIds" value="<c:out value="${activityInfo.tradeProductIds}"/>" />
						   <a href="" target="popupWin" id="popupLink2" onclick="setProductIds2();popupProOpen();"><span style="display:inline-block;margin:6px 0 0 0;" class="back_dblue btn"><i class="icon-btn icon-add"></i>添加商品</span></a>
						   </span>
						<thead  style="background:#EBEBEB;">
							<th>商品名称</th>
							<th>商品条形码</th>
	...
	var trim_Version=version[1].replace(/[ ]/g,""); 
	 if(browser=="Microsoft Internet Explorer" && trim_Version=="MSIE9.0") {
	  $(".compa").css("margin","0px 0px 6px 0px")
	}
	 ...
	 function setProductIds2(){
		 var checkedProductId = $("#tradeProductIds").val();
		 var action = "<%=basePath%>/product/selectPopup?popupFlg=2&params=2&tradeProductIds="+checkedProductId;
		 $("#popupLink2").attr("href",action);
	 }
	//选择完以后重新判断高度。
	 function funcHeight(){
