...
<c:out value="${message }" />
		<section class=" height_all"><!-- cont_section -->
				<!-- <header class="cont_section_header">Banner修改</header> -->
				<header class="cont_section_header_bread">
					...
					<span style="color:#3bb3e0;">banner修改</span>
				</header>
							...
							<div class="editPage">
								<div class="editLeft">
									<div class="row-list">
										...
										<input name="banner_name" id="banner_name" type="text" class="td_text_w" value="${bannerInfo.banner_name}"/>
									</div>
									<div class="row-list">
