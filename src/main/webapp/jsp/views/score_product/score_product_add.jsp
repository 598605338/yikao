...
function doSubmit(){
	...
	if(exchangeType==null || exchangeType==''){
        document.saveForm.exchangeType.focus();
        alert("请选择兑换方式！");return false;
	}
	if(score==null || score==''){
		document.saveForm.score.focus();
...
<div id="wrap">
	...
	<form name="saveForm" class="goods_new" action="add" method="post" enctype="multipart/form-data">
			...
			<tbody>
				<tr class="height">
					...
					<td class="td_right">
						...
						<input class="td_text_w" type="hidden" name="type" id="type" value="" />
				...
				<tr class="height">
					...
					<td class="td_right">
						<input style="border:none;" class="left" type="radio" name="exchangeType" onclick="changeDisplay(0);" value="0" checked="checked" /><label class="left">积分</label> 
			  ...
			  <tr class="height">
				...
				<tr class="height">
					...
					<td class="td_right">
						<input class="td_text_w" type="text" name="score" id="score" value="" maxlength="4" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
					</td>
				</tr>
				<tr id="priceDiv" class="height">
					...
					<td class="td_right">
						<input class="td_text_w" type="text" name="price" id="price" value="" maxlength="10" onkeyup="clearNoNum(this);"/>元
					</td>
				</tr>
				<tr class="height">
					<td class="td_left">
					...
					<td class="td_right">
						<input class="td_text_w" type="text" name="quantity" id="quantity" value=""  maxlength="4" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/><label>张</label> 
					</td>
				</tr>
				<tr class="height">
					<td class="td_left">
					...
					<td class="td_right">
						<input class="td_text_w" type="text" name="limitQuantity" id="limitQuantity" value=""  maxlength="4" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/><label>张</label> 
					</td>
				</tr>
				<tr class="height">
					<td class="td_left">
		...
		<div class="bgbtn">
			...
			<input style="margin-left:-146%;" type="button" value="返回" class="left btn back_dblue" onclick="doBack()" /> -->
			<button type="button" style="margin-left:-202%;" onclick="doSubmit();" class="left back_dblue btn"><i class="icon-btn icon-save"></i>保存</button>
			<button type="button" style="margin-left:-146%;" class="left back_dblue btn" onclick="doBack();"><i class="icon-btn icon-goback"></i>返回</button>
		</div>
	</form>
	</section>
