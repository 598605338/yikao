					...
					var activity_ids="";
						...
						if(activity_ids){
							...
							<%-- $.ajax({			
									...
									type:"POST",
									data: 'activity_ids='+data1+"&activity_type="+2,
									dataType: 'text',
							...
							window.location.href="<%=path%>/promotion/deleteActInfoById?activity_ids="+data1+"&activity_type=2";
						}
			}
			
			function addNew(){
				window.location.href="<%=path%>/jsp/views/activity_promotion_manage/product_discount_add.jsp";
			}
				...
				<section class="cont_section_section">					
					<div class="goodsManage">
						...
						<div class="section_table" >
							<table cellspacing="none" style="margin:-2px auto;" class="table_hover">
						<div class="height compa">
							...
							<span ><button type="button" class="left back_dblue btn" onclick="addNew()"><i class="icon-btn icon-add"></i>新增</button><button type="button" class="left back_dblue btn" onclick="delAll()"><i class="icon-btn icon-delete"></i>删除</button></span>
...
<script type="text/javascript">
	...
	var trim_Version=version[1].replace(/[ ]/g,""); 
	 if(browser=="Microsoft Internet Explorer" && trim_Version=="MSIE9.0") {
	  $(".compa").css("margin","20px 0px -10px 3px")
	}
	</script>
</html>
