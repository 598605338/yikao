...
<c:out value="${message }" />
					...
					<div class="goodsManage">
						...
						<div class="editPage">
							<div class="editLeft">
								...
								<div class="row-list">
									<label>促销折扣：</label>
									<input class="td_text_w" name="discount" id="discount" type="text" class="left" value="${activityInfo.discount}"/>
								</div>
								<div class="row-list">
									<label>参与门店：</label>
								...
								<div id="addMallBtn" class="row-list">
									<label><a href="<%=basePath%>/shop/shopwinList?pageIndex=1" target="popupWin1" onclick="popupProOpen1();"><span style="margin: 0;" class="back_dblue left btn" class="back_dblue left btn"><i class="icon-btn icon-add"></i>添加门店</span></a></label>
									<div id="mall_names" class="td_text_w" style="min-height: 30px; border: 1px solid #aaa;"></div>
								</div>
								<div class="row-list">
									<label>促销标签：</label>
									<input type="text" id="promotion_label"  class="td_text_w" value="${activityInfo.promotion_label}" name="promotion_label">
								</div>
							</div>
							<div class="line"></div>
							<div class="editRight">
						...
						<hr>
							...
							<span>
								...
								<a href="" id="popupLink" target="popupWin" onclick="setProductIds();popupProOpen();"><span style="display:inline-block;margin:6px 0% 0% 0%;" class="back_dblue btn compa"><i class="icon-btn icon-add"></i>添加商品</span></a>
							</span>
    ...
    <div id="popupDiv1" style="position: absolute;z-index:1002;display:none;width: 90%; height: 90%; background-color: white; position: absolute; left: 5%; top:6%;padding: 0 14px;">
        <span class="disp" onclick="popupProClose1();" style="cursor:pointer;position:absolute;top:-15px;right:-15px;height:40px;width:40px;border-radius:20px;line-height:34px;color:#000;text-align:center;font-size:30px;">×</span>  
...
<script type="text/javascript">
	...
	var trim_Version=version[1].replace(/[ ]/g,""); 
	 if(browser=="Microsoft Internet Explorer" && trim_Version=="MSIE9.0") {
	  $(".compa").css("margin","6px 0px 8px 3px")
	}
	 /* 选择完重新选择高度 */
	 function funcHeight(){
