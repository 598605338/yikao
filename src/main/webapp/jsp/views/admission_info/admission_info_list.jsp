	...
	<div id="wrap">
				...
				<section class="cont_section_section">					
					...
					<form name="form" id="formSubmit" action="select" method="post">
						...
						<div class="row">
							<input type="text" name="batchName" id="batchName" placeholder="批次名称" value="<c:out value="${query.batchName }"/>" class="td_text_w" />
						</div>
						<div class="col-click">
						...
						<div class="section_table">
							...
							<div class="click">
							<a href="javascript:void(0)" onclick="location.href='toAdd'"><span class="left back_dblue btn"><i class="icon-btn icon-add"></i>新增录取信息</span></a>
