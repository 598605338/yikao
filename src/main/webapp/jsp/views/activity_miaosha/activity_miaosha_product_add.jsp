...
<div id="wrap">
	...
	<div id="tab_list">
        <div class="tab_title clear">
            <span class="left leftBtn" href="javascript:void(0);">&lt;</span>
            ...
            <span class="right rightBtn" href="javascript:void(0);">&gt;</span>
        </div>
        <div class="tab_body">
        	<div class="tab_main hid">
				...
				<div class="editPage">
					<div class="editLeft">
						...
						<div class="row-list">
							<label>商品图片地址：</label>
        					<img src="<%=path %>/js/inputFile/btn.png" style="border: 1px solid #aaa;width: 182px; height: 142px;" name="imageSrc" id="imageSrc" class="img1"  lang="addItem"/>
			...
			<div class="bgbtn">
			       <!-- <input  type="button" value="保存" onclick="submitForm(this);return false;" class="left btn back_dblue" />
				   <input type="button" value="删除" onclick="deleteFrom(this);return false;" class="left btn back_dblue deleteBtn" /> -->
				   <button type="button" onclick="submitForm(this);return false;" class="left btn back_dblue" ><i class="icon-btn icon-save"></i>保存</button>
				   <button class="left btn back_dblue" onclick="doBack()" ><i class="icon-btn icon-next"></i>完成</button>
	...
	<%-- <div id="addItem" style="display:none;">
		<form class="goods_new" action="" name="saveForm" method="post">
			<input class="left" type="hidden" name="panicBuyingStartTimeStr" id="panicBuyingStartTimeStr" value='<fmt:formatDate value="${miaoshaActivityBase.panicBuyingStartTime }" pattern="yyyy-MM-dd HH:mm:ss"/>' />
			<input class="left" type="hidden" name="panicBuyingEndTimeStr" id="panicBuyingEndTimeStr" value='<fmt:formatDate value="${miaoshaActivityBase.panicBuyingEndTime }" pattern="yyyy-MM-dd HH:mm:ss"/>' />
			<input class="left" type="hidden" name="shangouBaseId" id="shangouBaseId" value="<c:out value="${miaoshaActivityBase.id }"/>" />
			<input type='hidden' name='id' id='id' value='' lang="addItem"/>
			...
			<tbody>
				<tr class="height">
					...
					<td class="td_right">
						<input class="td_text_w" type="text" name="pName" id="pName" readonly="readonly" value="" lang="addItem"/>
						<input class="td_text_w" type="hidden" name="productId" id="productId" value=""  lang="addItem"/>
						<input class="td_text_w" type="hidden" name="pSendType" id="pSendType" value=""  lang="addItem"/>
						<a lang="popupLink" href="" target="popupWin" onclick="popupProOpen();"><span style="display:inline-block;" class="back_dblue btn">选择</span></a>
					</td>
				</tr>
				<tr class="height">
					<td class="td_left">
				...
				<tr class="height">
					...
					<td class="td_right">
        					<img src="<%=path %>/js/inputFile/btn.png" width="120px" name="imageSrc" id="imageSrc" class="img1"  lang="addItem"/>
        					<input type="hidden" value="" name="imagePath" id="imagePath" lang="addItem"/>
					</td>
				</tr>
				<tr class="height">
...
$(function(){
    ...
    function fixedWrapWidth(){
        $(".fixed_wrap").css("width",$(".tab_title").width()-56);
    }
    /**
...
/* function deleteFrom(o){
	var _JqueryForm = $(o).closest("[name='saveForm']");
